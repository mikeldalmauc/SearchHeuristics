...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{tsp.example} \hlkwb{<-} \hlkwd{tspProblem}\hlstd{(}\hlkwc{cmatrix}\hlstd{=cost.matrix)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{l} \hlkwb{<-} \hlkwd{paste}\hlstd{(}\hlstr{"c"}\hlstd{,} \hlnum{1}\hlopt{:}\hlstd{n,} \hlkwc{sep}\hlstd{=}\hlstr{""}\hlstd{)}
\hlstd{> }\hlstd{rnd.sol} \hlkwb{<-} \hlkwd{factor}\hlstd{(}\hlkwd{sample}\hlstd{(l[}\hlnum{1}\hlopt{:}\hlnum{3}\hlstd{],} \hlkwc{size}\hlstd{=n,} \hlkwc{replace}\hlstd{=}\hlnum{TRUE}\hlstd{),} \hlkwc{levels}\hlstd{=l)}
\hlstd{> }\hlstd{rnd.sol}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{gcol.problem}\hlopt{$}\hlkwd{valid}\hlstd{(rnd.sol)}
\end{alltt}
\begin{verbatim}
## [1] FALSE
\end{verbatim}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: colorspace}}\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{trivial.sol} \hlkwb{<-} \hlkwd{factor} \hlstd{(l,} \hlkwc{levels}\hlstd{=l)}
...
\end{verbatim}
\begin{alltt}
\hlstd{> }\hlstd{gcol.problem}\hlopt{$}\hlkwd{valid}\hlstd{(trivial.sol)}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{alltt}
  \hlkwd{names}(solution) <- NULL
  \hlkwd{return}(\hlkwd{permutation}(vector=solution))
\}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{1, 1, 1}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{> }\hlstd{greedy.solution} \hlkwb{<-} \hlkwd{tsp.constructive}\hlstd{(cost.matrix)}
